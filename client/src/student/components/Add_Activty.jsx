  ...
  return (
    <div>
      ...
      <p className="text-xs lg:text-base  text-red-500">
        ให้นักศึกษากรอกข้อมูลรหัสกิจกรรม 8
        หลักในบัตรกิจกรรมเพื่อยืนยันการเข้าร่วมกิจกรรม
        (รหัสบัตรกิจกรรมสามารถใช้ได้เพียงครั้งเดียวเท่านั้น)
      </p>
      <br />
      <form className="grid grid-cols-1 gap-2">
        <div className="grid md:grid-cols-2 gap-2 items-center">
          <label htmlFor="activity" className="md:text-lg text-base">
            กิจกรรมที่ต้องการยืนยันการลงทะเบียน
          </label>
          <select
            id="activity"
            className="border"
          ...
          >
            <option value="" disabled className="text-center">
              ----- เลือกกิจกรรมที่ต้องการยืนยัน -----
            </option>
            {activities.map((activity) => (
              <option
                key={activity.act_ID}
                value={activity.act_ID}
        ...
        <div className="grid md:grid-cols-2 gap-2 items-center">
          <label htmlFor="" className="md:text-lg text-base ">
            กรอกรหัสบัตรกิจกรรม
          </label>
        ...
        <div className="w-full flex justify-center mt-5">
          <button
            type="submit"
            className="bg-lime-500 w-fit p-3 rounded-md text-white text-base md:text-lg"
          >
